...
variable "priv_cluster_instance_type" {
  type        = string
  description = "EC2 instance type for the EKS autoscaling group."
  default     = "t2.medium"
}
variable "priv_cluster_asg_desired_capacity" {
  type        = number
  description = "The default number of EC2 instances our EKS cluster runs."
  default     = 1
}

variable "priv_cluster_asg_min_size" {
  type        = number
  description = "The minimum number of EC2 instances our EKS cluster will have."
  default     = 1
}

variable "priv_cluster_asg_max_size" {
  type        = number
  description = "The maximum number of EC2 instances our EKS cluster will have."
  default     = 5
}

variable "pub_cluster_instance_type" {
  type        = string
  description = "EC2 instance type for the EKS autoscaling group."
  default     = "t2.medium"
}
variable "pub_cluster_asg_desired_capacity" {
  type        = number
  description = "The default number of EC2 instances our EKS cluster runs."
  default     = 1
}

variable "pub_cluster_asg_min_size" {
  type        = number
  description = "The minimum number of EC2 instances our EKS cluster will have."
  default     = 1
}

variable "pub_cluster_asg_max_size" {
  type        = number
  description = "The maximum number of EC2 instances our EKS cluster will have."
  default     = 5
}
